        ...
        if isinstance(response, discord.Embed):
            ...
            while text_response:
                ...
                if len(text_response) > split_point:
                    ...
                    last_code_block_end = text_response.rfind("```", 0, split_point)
                    next_code_block_start = text_response.find("```", last_code_block_end + 3)
                    # If we're starting inside a code block, find the end of it
                    if next_code_block_start != -1 and next_code_block_start < split_point:
                ...
                chunk, text_response = text_response[:split_point], text_response[split_point:]
